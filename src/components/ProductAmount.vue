<template>
  <v-layout align-center justify-space-between class="slider">
    <v-btn class="ma-0" fab small @click.native="itemRemoved" ref="increase-quantity">
    ...
    <v-btn class="ma-0" fab small @click.native="$store.commit('cart/addToCart', product)" ref="decrease-quantity">
